...
using Backbone.Language.Core.Extensions.Enums.Benchmarks;
using Backbone.Language.Core.Extensions.Enums.Extensions;
using BenchmarkDotNet.Attributes;
using BenchmarkDotNet.Running;

BenchmarkRunner.Run<EnumExtensionsBenchmark>();

namespace Backbone.Language.Core.Extensions.Enums.Benchmarks
{
